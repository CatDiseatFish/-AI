  ...
  >
    ...
    >
      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <h2 class="text-lg font-bold text-white">导出项目</h2>
        <button
      ...
      <div class="p-6 space-y-6">
        ...
        <div>
          <h3 class="text-white font-medium mb-3">选择导出内容</h3>
          <div class="space-y-2">
            <!-- Characters -->
            <label class="flex items-center gap-3 p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
              <input
                v-model="exportCharacters"
                type="checkbox"
                class="w-5 h-5 rounded-lg bg-white/10 border-white/20 checked:bg-[#00FFCC] checked:border-[#00FFCC] text-black focus:ring-2 focus:ring-[#00FFCC] focus:ring-offset-0"
              >
              <div class="flex-1">
                <div class="text-white text-sm font-medium">角色画像</div>
                <div class="text-white/60 text-xs">导出所有角色的生成图片</div>
              </div>
            </label>
            ...
            <label class="flex items-center gap-3 p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
              ...
              >
              <div class="flex-1">
                <div class="text-white text-sm font-medium">场景画像</div>
                <div class="text-white/60 text-xs">导出所有场景的生成图片</div>
              </div>
            </label>
            ...
            <label class="flex items-center gap-3 p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
              ...
              >
              <div class="flex-1">
                <div class="text-white text-sm font-medium">分镜图</div>
                <div class="text-white/60 text-xs">导出所有分镜的静态图片</div>
              </div>
            </label>
            ...
            <label class="flex items-center gap-3 p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
              ...
              >
              <div class="flex-1">
                <div class="text-white text-sm font-medium">分镜视频</div>
                <div class="text-white/60 text-xs">导出所有分镜的生成视频</div>
              </div>
            </label>
          </div>
        </div>
        ...
        <div>
          <h3 class="text-white font-medium mb-3">版本选择</h3>
          <div class="space-y-2">
            <!-- Current Version -->
            <label class="flex items-center gap-3 p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
              <input
                ...
                type="radio"
                value="CURRENT"
                class="w-5 h-5 rounded-full bg-white/10 border-white/20 checked:bg-[#00FFCC] checked:border-[#00FFCC] text-black focus:ring-2 focus:ring-[#00FFCC] focus:ring-offset-0"
              >
              <div class="flex-1">
                <div class="text-white text-sm font-medium">仅当前版本</div>
                <div class="text-white/60 text-xs">只导出每个资产的当前活跃版本</div>
              </div>
            </label>
            ...
            <label class="flex items-center gap-3 p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
              ...
              >
              <div class="flex-1">
                <div class="text-white text-sm font-medium">包含所有版本</div>
                <div class="text-white/60 text-xs">导出所有历史版本(文件较大)</div>
              </div>
            </label>
          </div>
        </div>
      ...
      <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-white/10">
        ...
        <button
          class="px-6 py-2 rounded-2xl bg-[#00FFCC] text-black font-medium hover:bg-[#00FFCC]/80 transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
