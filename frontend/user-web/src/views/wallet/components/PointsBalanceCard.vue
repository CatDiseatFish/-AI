...
<template>
  <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <button
        class="px-4 py-1.5 rounded-full text-sm bg-[#00FFCC] text-[#0D0E12] font-semibold hover:bg-[#00FFCC]/90 transition-colors"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="bg-white/5 border border-white/10 rounded-xl p-5">
        <div class="flex items-center gap-3 mb-3">
          <div class="w-10 h-10 rounded-full bg-[#00FFCC]/20 flex items-center justify-center">
            <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-[#00FFCC]">
      ...
      <div class="bg-white/5 border border-white/10 rounded-xl p-5">
        <div class="flex items-center gap-3 mb-3">
          ...
          <div>
            <p class="text-white/60 text-xs">冻结积分</p>
            <p class="text-2xl font-bold text-white/80 mt-0.5">
    ...
    <div class="mt-6 pt-5 border-t border-white/10">
      <div class="flex items-center justify-between">
        <span class="text-white/60 text-sm">总计</span>
